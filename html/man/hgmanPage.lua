...
<body>
    <div id="container">
        ...
        <div id="main">
            <div class="byDeny">
                <iframe src="/bydlist" id="bydPage" name="bydPage" width="100%" onLoad="iframeHeight(id)" frameborder=0 ></iframe>
            </div>
            <div class="byWhite">
                <iframe src="/bywlist" id="bywPage" name="bywPage" width="100%" onLoad="iframeHeight(id)" frameborder=0 ></iframe>
            </div>
            <div class="black">
                <iframe src="/blist" id="blPage" name="blPage" width="100%" onLoad="iframeHeight(id)" frameborder=0 ></iframe>
            </div>
            <div class="white">
                <iframe src="/wlist" id="whPage" name="whPage" width="100%" onLoad="iframeHeight(id)" frameborder=0 ></iframe>
            </div>
            <div class="challenge">
                <iframe src="/clist" id="chPage" name="chPage" width="100%" onLoad="iframeHeight(id)" frameborder=0 ></iframe>
            </div>
        </div>

    </div>
<div id="goToTop"><span>^Top</span></div>
<div id="goToRight"><span><a text-decoration: none; href="/hgman2">->></a></span></div>
]]
