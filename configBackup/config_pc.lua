...
local Config = {
    ...
    limitReqModules = { state = "Off", maxReqs = 2160, amongTime = 10, urlProtect = baseDir .. "url-protect/limit.txt" },
    ...
    --keySecret : 用于生成token的密码,如果上面的keyDefine为dynamic,就不需要修改.
    --urlProtect : 同limitReqModules模块中的urlProtect的解释.
    cookieModules = { state = "On", verifyMaxFail = 2, keySecret = 'bGMfY2D5t3', amongTime = 3600, urlProtect = baseDir .. "url-protect/cookie.txt" },
    ...
    blockAction = { type = "click", hiddenClickState = "On" },
    ...
    urlFilterModules = { state = "On", allowState = "On", denyState = "On", urlAllowProtect = baseDir .. "url-protect/urlAllow.txt", urlDenyProtect = baseDir .. "url-protect/urlDeny_tab.txt" },
    ...
    perUrlRateLimit = { state = "On", amongTime = 90, inPerUrlRateLimitAmongTime = 900, defaultMaxReqs = 20, inPerUrlRateLimitMaxTimes = 2, verifyBlockTime = 86400, verifyOkTime = 30, perUrlRateLimit2ByDenyState = "On", toByDenyAmongTime = 86400, perUrlRateLimitVerifySuccessMax = 4, inByDenyTime = 7200, model = 1, direct2byDeny = 0, urlProtect = baseDir .. "url-protect/perUrlRateLimit.txt" },
