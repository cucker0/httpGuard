...
local Config = {
	...
	-- keySecret : 用于生成token的密码,如果上面的keyDefine为dynamic,就不需要修改.
	-- urlProtect : 同limitReqModules模块中的urlProtect的解释.	
	cookieModules = { state = "On" ,verifyMaxFail = 4, keySecret = 'bGMfY2D5t3', amongTime = 600 , urlProtect = baseDir.."url-protect/cookie.txt"},
	...
	perUrlRateLimit = { state = "On", amongTime = 90, inPerUrlRateLimitAmongTime = 900, defaultMaxReqs = 30, inPerUrlRateLimitMaxTimes = 4, verifyBlockTime = 7200, verifyOkTime = 30, perUrlRateLimit2ByDenyState = "On", toByDenyAmongTime=7200, perUrlRateLimitVerifySuccessMax = 4,  inByDenyTime=7200, model = 1, direct2byDeny = 0, urlProtect = baseDir.."url-protect/perUrlRateLimit.txt" },
